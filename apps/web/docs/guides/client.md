...
The `kineo` function takes in two parameters: an [adapter](./adapters), and a [schema](./schema). Kineo creates a new model instance for each model definition from your schema.
